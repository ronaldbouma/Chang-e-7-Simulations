...
int main( )
{
    ...
    accelerationsOfAsterix[ "Moon" ].push_back( std::make_shared< SphericalHarmonicAccelerationSettings >( 15, 15 ) );
    ...
    asterixInitialStateInKeplerianElements( semiMajorAxisIndex ) = 2000.0E3;
    asterixInitialStateInKeplerianElements( eccentricityIndex ) = 0.1;
    asterixInitialStateInKeplerianElements( inclinationIndex ) = convertDegreesToRadians( 88.3 );
    ...
    std::string outputSubFolder = "harmonictest/";
