...
#the main simulation function. This one does the simulations in sequence. takes an absolute age\
    #to complete. better to use the simulation select to do individual simulations
