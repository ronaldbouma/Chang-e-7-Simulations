...
#script to get the amount of times a direction is sampled given the input parameters
#uses keplerian mechanics, can expand easily to use tudat data by importing data from tudat orbit
#cd
import os
import sys
