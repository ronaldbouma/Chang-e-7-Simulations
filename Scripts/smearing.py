...
#script to estimate decoherence 
...
velocity = np.zeros((len(time_span),3))
...
for i in tqdm(range(len(time_span))):
    ...
    Baselines[i] = Ds[2] 
    velocity[i] = (-(Ds[4][0]-Ds[4][-1])+(Ds[5][0]-Ds[5][-1]))/depth
...
x_hats = model_x[select]
velocity_directional = np.zeros((len(x_hats),20))

for k in range(len(velocity_directional)):
    velocity_directional[k] = np.linalg.norm(x_hats[k]*velocity,axis=1)


velocity_directional = np.round(velocity_directional,1)
...
for h in range(len(time_select)):
    plt.plot(t_int,(decoherence[time_select[h],:,select[0]]),label='{} m/s'.format(velocity_directional[0][time_select[h]]))
    plt.plot(t_int,(decoherence[time_select[h],:,select[1]]),label='{} m/s'.format(velocity_directional[1][time_select[h]]))
    plt.plot(t_int,(decoherence[time_select[h],:,select[2]]),label='{} m/s'.format(velocity_directional[2][time_select[h]]))
    plt.plot(t_int,(decoherence[time_select[h],:,select[3]]),label='{} m/s'.format(velocity_directional[3][time_select[h]]))
    plt.plot(t_int,(decoherence[time_select[h],:,select[4]]),label='{} m/s'.format(velocity_directional[4][time_select[h]]))
    plt.plot(t_int,(decoherence[time_select[h],:,select[5]]),label='{} m/s'.format(velocity_directional[5][time_select[h]]))
    plt.xlabel('time in seconds')
    plt.ylabel('decoherence')
    plt.title('Decoherence at {} Mhz'.format(frequency/1e6))
    plt.legend()
...
#plt.plot(t_int,(decoherence[time_select[p],:,select[0]]),label='{} m/s'.format(velocity_directional[0][time_select[p]]))
plt.plot(t_int,(decoherence[time_select[p],:,select[1]]),label='{} m/s'.format(velocity_directional[1][time_select[p]]))
#plt.plot(t_int,(decoherence[time_select[p],:,select[2]]),label='{} m/s'.format(velocity_directional[2][time_select[p]]))
plt.plot(t_int,(decoherence[time_select[p],:,select[3]]),label='{} m/s'.format(velocity_directional[3][time_select[p]]))
#plt.plot(t_int,(decoherence[time_select[p],:,select[4]]),label='{} m/s'.format(velocity_directional[4][time_select[p]]))
plt.plot(t_int,(decoherence[time_select[p],:,select[5]]),label='{} m/s'.format(velocity_directional[5][time_select[p]]))
plt.xlabel('time in seconds')
plt.ylabel('decoherence')
plt.title('Decoherence at {} Mhz'.format(frequency/1e6))
plt.legend()
