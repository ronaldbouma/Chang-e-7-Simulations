...
#script to do a single simulation given arguments in the command line
#arguments are: frequency in mhz,amount of baselines in thousands, nc or cl for non cleaned or cleaned, hr and lr for high res/low res 
