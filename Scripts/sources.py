...
plt.hlines(numbers[0],mean[0],10,ls='--',color='b')
plt.hlines(numbers[1],mean[1],10,ls='--',color='y')
plt.hlines(numbers[2],mean[2],10,ls='--',color='g')
plt.hlines(numbers[3],mean[3],10,ls='--',color='r')
plt.hlines(numbers[4],mean[4],10,ls='--',color='m')
